...
namespace PrimeTween {
    public partial struct Tween {
        ...
        static Tween animate<T>(object target, ref TweenSettings<T> settings, [NotNull] Action<ReusableTween> setter, Func<ReusableTween, ValueContainer> getter, TweenType _tweenType) where T : struct{
            var tween = PrimeTweenManager.fetchTween();
            tween.startValue.CopyFrom(ref settings.startValue);
            tween.endValue.CopyFrom(ref settings.endValue);
        ...
        static Tween animateWithIntParam<T>([NotNull] object target, int intParam, ref TweenSettings<T> settings, [NotNull] Action<ReusableTween> setter, [NotNull] Func<ReusableTween, ValueContainer> getter, TweenType _tweenType) where T : struct{
            var tween = PrimeTweenManager.fetchTween();
